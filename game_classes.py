...
class Item:
    def __init__(self, name, description, on_look="", can_take=False):
...
class Interactables:
    def __init__(self, name, description, on_look="", on_interact=""):
...
class Scenery:
    def __init__(self, name, description, on_look=""):
